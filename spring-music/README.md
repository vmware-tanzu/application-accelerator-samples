...
<!--- #IF(#persistenceType == 'mongodb') -->
```shell
tanzu service bind MongoDBInstance/music ContainerApp/spring-music --as music
```
<!--- #ENDIF -->
<!--- #IF(#persistenceType == 'redis') -->
```shell
tanzu service bind RedisCluster/music ContainerApp/spring-music --as music
```
<!--- #ENDIF -->
<!--- #IF(#persistenceType == 'jpa') -->
If you are using MySQL then use:
...
```shell
tanzu service bind MySQLInstance/music ContainerApp/spring-music --as music
```

And, if you are using PostgreSQL then use:

```shell
tanzu service bind PostgreSQLInstance/music ContainerApp/spring-music --as music
```
<!--- #ENDIF -->
