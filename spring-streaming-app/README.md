...
```sh
cat .tanzu/config/streaming-app.yml
```
...
### Review logs for the running app

You can use the following command to review logs of the deployed app:

```sh
tanzu app logs streaming-app
```
