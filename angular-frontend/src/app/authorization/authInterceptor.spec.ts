...
describe('AuthInterceptor', () => {
  ...
  //
  // fit('should start authentication flow on 401/403 errors', async () => {
  ...
  //   const resultPromise = interceptor.intercept(mockRequest as any, {
  //     handle: (req: HttpRequest<any>) => {
  ...
  //
  //   try {
  //     const result = await lastValueFrom(resultPromise);
